...
int main(){
  ...
  std::cout << television_1.cuanto_dura(television_1.get_antig()) << std::endl;
  std::cout << television_1.descuento_vejez(television_1.get_antig(), television_1.get_precio()) << std::endl;
  ...
  std::cout << cama_1.cuanto_dura(cama_1.get_antig()) << std::endl;
  std::cout << cama_1.descuento_vejez(cama_1.get_antig(), cama_1.get_precio()) << std::endl;
  ...
  std::cout << mesa_1.cuanto_dura(mesa_1.get_antig()) << std::endl;
  std::cout << mesa_1.descuento_vejez(mesa_1.get_antig(), mesa_1.get_precio()) << std::endl;
}
